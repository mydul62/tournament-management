...
import { Trophy, Calendar, MapPin, AlignLeft, CheckCircle2 } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-sm">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-3 px-6 rounded-xl bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-slate-950 font-extrabold transition-colors shadow-lg shadow-emerald-500/20"
            >
